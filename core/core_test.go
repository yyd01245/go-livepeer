...
func TestTranscode(t *testing.T) {
	...
	n, _ := NewLivepeerNode(&eth.StubClient{}, stubnet, "12209433a695c8bf34ef6a40863cfe7ed64266d876176aee13732293b63ba1637fd2", []string{"test"}, ".tmp", nil)
...
func TestNotifyBroadcaster(t *testing.T) {
	...
	seth := &eth.StubClient{}
	n, _ := NewLivepeerNode(seth, nw, "12209433a695c8bf34ef6a40863cfe7ed64266d876176aee13732293b63ba1637fd2", []string{}, "./tmp", nil)
	sn := &StubVideoNetwork{}
	n.VideoNetwork = sn
