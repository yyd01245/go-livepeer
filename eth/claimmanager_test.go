...
func TestShouldVerify(t *testing.T) {
	...
	cm := NewBasicClaimManager("strmID", big.NewInt(5), ethcommon.Address{}, big.NewInt(1), ps, client, &ipfs.StubIpfsApi{}, nil)
...
func TestProfileOrder(t *testing.T) {
	ps := []ffmpeg.VideoProfile{ffmpeg.P240p30fps16x9, ffmpeg.P360p30fps4x3, ffmpeg.P720p30fps4x3}
	cm := NewBasicClaimManager("strmID", big.NewInt(5), ethcommon.Address{}, big.NewInt(1), ps, &StubClient{}, &ipfs.StubIpfsApi{}, nil)
